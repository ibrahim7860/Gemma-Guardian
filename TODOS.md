...
- **Owner:** Qasim (Person 3) — reassigned 2026-05-12 from Ibrahim. Ibrahim's machine cannot host the 3-drone live-Gemma stack reliably (Apple Silicon Ollama-saturation, see STATUS.md Day-10 evening note); Qasim's machine has the headroom. Kaleel on call if frame mapping needs to change.
