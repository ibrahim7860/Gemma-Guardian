...
The technical writeup is one of the three submission deliverables (alongside repo and video). Judges read it after watching the video to evaluate technical depth. This doc gives the locked structure so Person 5 can draft cleanly without inventing the outline.
