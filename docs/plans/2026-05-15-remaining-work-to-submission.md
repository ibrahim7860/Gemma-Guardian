...
- [ ] **J5.** [Each owner] Code-quality sweep on own lane: no commented-out blocks, no `print` debug, no hardcoded home paths, no secrets, Black-formatted Python, dartfmt Flutter.
  ...
  - [ ] **Qasim agents/egs_agent/** — pending
  - [ ] **Kaleel ml/** — pending
